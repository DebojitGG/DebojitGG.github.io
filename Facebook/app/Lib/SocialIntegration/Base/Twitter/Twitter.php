...
class Twitter
{
   /**
     ...
     */
    public function oauth_requestToken($oauth_callback)
    {include_once 'TwitterOAuth.php';
       $TwitterOauth = new TwitterOAuth(self::$_oauth_consumer_key, self::$_oauth_consumer_secret);
       $TwitterRequestToken = $TwitterOauth->getRequestToken($oauth_callback);
      $this->setToken($TwitterRequestToken['oauth_token'], $TwitterRequestToken['oauth_token_secret']);      
    }
     ...
     * @return string The OAuth authorize URL
     */
    public function oauth_accessToken($oauth_verifier)
    {  
       include_once 'TwitterOAuth.php';
       $this->setToken($_GET['oauth_token'], $oauth_verifier);
       $TwitterOauth = new TwitterOAuth(self::$_oauth_consumer_key, self::$_oauth_consumer_secret, $this->_oauth_token, $this->_oauth_token_secret);
       $TwitterAccessToken = $TwitterOauth->getAccessToken($oauth_verifier); 
      $this->setToken($TwitterAccessToken['oauth_token'], $TwitterAccessToken['oauth_token_secret']);      
    }
     ...
     *
     * @return string The OAuth Secret
     */
