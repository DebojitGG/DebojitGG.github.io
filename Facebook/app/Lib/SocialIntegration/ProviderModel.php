<?php
abstract class SocialIntegration_Provider_Model
{
	/**
	...
	function __construct( $providerId, $config, $params = NULL )
	{
		...
		// SocialIntegration_Logger::debug( "SocialIntegration_Provider_Model::__construct( $providerId ) initialized. dump current adapter instance: ", serialize( $this ) );
	}
	...
	*/
	...
	{
		// SocialIntegration_Logger::error( "SocialIntegrationAuth do not provide users contacts list for {$this->providerId} yet." );
	...
	*/
	...
	{
		SocialIntegration_Logger::error( "SocialIntegrationAuth do not provide user's activity stream for {$this->providerId} yet." ); 
